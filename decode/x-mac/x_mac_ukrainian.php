 ...
 * is needed to read x-mac-ukrainian encoded mails in non-x-mac-ukrainian locale.
 * 
 ...
 */
function charset_decode_x_mac_ukrainian ($string) {
    // don't do decoding when there are no 8bit symbols
    if (! sq_is8bit($string,'x-mac-ukrainian'))
        return $string;
